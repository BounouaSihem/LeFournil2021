package fr.fournil.bakery.tools.json;
...
public class JSONLoader<T> {
    ...
    public static final String FournilBack_PATH = "/FournilBack/";
    ...
    public List<T> load() {
        ...
        final String cwdDirectory = resourceDir.substring(0, resourceDir.lastIndexOf(FournilBack_PATH));
        final String url = cwdDirectory +FournilBack_PATH + this.path;
